...
namespace Fietsen.Lib.Entities
{
    public class Fiets
    {
        ...
        public static string[] Merken { get; set; } = { "Bamboo", "Novy", "Orbea", "Trek" };
        ...
        public string Merk
        {
            ...
            set 
            {
                if (Merken.Contains(value)) merk = value;
                else throw new Exception("Geef een geldig merk, geen prutsmerk");
